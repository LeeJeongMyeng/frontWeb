...
<jsp:include page="Market_Top2.jsp"></jsp:include>
	...
	<%
		String SearchKeyword = request.getParameter("Searchprod");
		if(SearchKeyword==null){SearchKeyword=" ";}
	MarketVO sch = new MarketVO(SearchKeyword);
	%>
	
	
	<div class="box" id="New_container"> 
		<div id="New_MainText"><h1>'<span><%=SearchKeyword%></span>'에 대한 검색결과</h1></div>
			<section class="New_content">
				...
				<main>
				<%
			for(MarketVO p:MPDao.getSearchCount(sch)){
			%>
					...
					<div class="clear"></div>
						<%
			for(MarketVO p:MPDao.getSearchList(sch)){
			%>
